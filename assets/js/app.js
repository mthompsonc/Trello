...
btn2.addEventListener('click', function() {
  ...
  if (ingreso === null || ingreso === '') {
    return alert('Debes ingresar un nombre para la lista!');
  } else {
  ...
  abtn3.addEventListener('click', function() {
    ...
    textarea1.placeholder = 'Ingresa tu nueva tarea.';
    ...
    btn4.addEventListener('click', function() {
      ...
      textarea1.value = '';
      if (tareatextarea === null || tareatextarea === '') {
        return alert('Debes ingresar una tarea!');
      } else {
